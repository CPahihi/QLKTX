...
namespace QLKTX.Controllers
{
    public class SiteController : Controller
    {
        ...
        public ActionResult DonTraPhong(int sinhVienID)
        {
            ...
            var phongInfo = (from dk in db.DKPhongs
                             ...
                             where dk.SinhVienID == sinhVienID && dk.NgayTra == null
                             orderby dk.NgayDK descending
                             select new { p.TenPhong, t.TenToaNha }).FirstOrDefault();

            var viewModel = new DonTraPhongViewModel
            {
                HoTen = sinhVien.HoSV + " " + sinhVien.TenSV,
                NgaySinh = (DateTime)sinhVien.NgaySinh,
                MSSV = sinhVien.MSSV,
                Phong = phongInfo != null ? phongInfo.TenToaNha + "." + phongInfo.TenPhong : "Chưa xếp",
                ToaNha = phongInfo != null ? phongInfo.TenToaNha : "Chưa xếp"
            };
        ...
        public ActionResult InfoSinhVien()
        {
            ...
            ViewBag.svID = sinhVien.SinhVienID;
